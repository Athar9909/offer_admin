...
import { editInformation, getInformation } from "../httpService/DashboardHttp";
...
const Informations = () => {
  ...
  const getData = async () => {
    ...
    if (!data.error) {
      setInfo(data?.results?.informations);
    }
  };

  const EditEn = (i) => {
    setId(i);
    reset({ title_en: info[i]?.title_en, content_en: info[i]?.content_en });
  };
  const EditAr = (i) => {
    setId(i);
    reset2({ title_ar: info[i]?.title_ar, content_ar: info[i]?.content_ar });
  };
            ...
            <div class="modal-body">
              ...
              >
                <div class="form-group col-12">
                  <label for={info[id]?._id}>Title</label>
                  <input
                    id={info[id]?._id}
                    type="text"
            ...
            <div class="modal-body">
              ...
              >
                <div class="form-group col-12 text-end">
                  <label class="text-end" for={info[id]?._id}>
                    Title
                  </label>
                  <input
                    id={info[id]?._id}
