        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-9 banner_content text-center">
              <h1 className="m-0">Post An Offer : Price</h1>
            </div>
          </div>
        </div>
      </section>
                          ...
                          <div className="col-12 form-group mb-4 pb-2">
                            <div className="row">
                              <div className="col-12 post_offer_top text-center">
                                <img src="assets/img/Price_post.png" alt="" />
                                <span>Your Item will be Offered Price</span>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="col-12">
                        <div className="row">
                          <div className="col-12 mb-4">
                            <div className="row Highest_bid_box border mx-0 pb-4 px-md-4 px-2 pt-3">
                              <div className="col-12 mb-4">
                                  ...
                                  <div className="col-6 text-center">
                                    <div className="checkbox_new d-inline-block">
                                      <input
                                        ...
                                        className="d-none"
                                      />
                                      <label for="02">Without Price</label>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="col-12 form-group mb-0 position-relative price_adjust">
