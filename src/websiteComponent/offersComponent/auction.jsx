        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-9 banner_content text-center">
              <h1 className="m-0">Post An Offer : Auction</h1>
            </div>
          </div>
        </div>
      </section>
                          ...
                          <div className="col-12 form-group mb-4 pb-2">
                            <div className="row">
                              <div className="col-12 post_offer_top text-center">
                                <img src="assets/img/Auction_post.png" alt="" />
                                <span>Your Item will be Offered Auction</span>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="row post_offer_data mx-0">
                      <div className="col-12">
                        <div className="row">
                          ...
                          <div className="col-12 form-group mb-4">
                            <div className="row Highest_bid_box border mx-0 pb-4 pt-3">
                              <div className="col-12 mb-4">
                                <div className="row mx-0 Highest_radio">
                                  <div className="col-6 text-center">
                                    <div className="checkbox_new d-inline-block">
                                      <input
                                        ...
                                        className="d-none"
                                      />
                                      <label for="01">Highest Bid</label>
                                    </div>
                                  </div>
                                  <div className="col-6 text-center">
                                    <div className="checkbox_new d-inline-block">
                                      <input
                                        ...
                                        className="d-none"
                                      />
                                      <label for="02">Initial Price</label>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="col-12 mb-0 text-center">
                                <div className="check_toggle justify-content-center">
                                  <input
                                    type="checkbox"
                                    checked
                                    name="j1"
                                  ...
                                  />
                                  <label for="j1"></label>
                                  <span>Set a time to end the auctions?</span>
                                </div>
                                <div className="number mt-4 pt-2">
